...
def generate_proxy_bundle(proxy_category, proxy_name, proxy_base_path, target_server_name, gcp_project_id, gcp_access_token):
    # Define directories for templates and output files
    source_tmpl_directory = r"C:\Users\omkar\OneDrive\Desktop\APIPGEE_CICD\apigee-cicd\terraform\templates\bundle\apiproxy"
    proxy_bundle_directory = os.path.join(r"C:\Users\omkar\OneDrive\Desktop\APIPGEE_CICD\apigee-cicd\terraform\proxies_export", proxy_name)  # API Name folder
    apiproxy_directory = os.path.join(proxy_bundle_directory, "apiproxy")  # apiproxy folder
    policies_tmpl_directory = r"C:\Users\omkar\OneDrive\Desktop\APIPGEE_CICD\apigee-cicd\terraform\templates\policies"
    ...
    zip_file_path = os.path.join(r"C:\Users\omkar\OneDrive\Desktop\APIPGEE_CICD\apigee-cicd\terraform\proxies_export", f"{proxy_name}.zip")
